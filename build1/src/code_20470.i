...
__asm__( ".section .text\n" "    .set noat\n" "    .set noreorder\n" "    .include \"" "asm/nonmatchings/code_20470" "/" "func_800B5870" ".s\"\n" "    .set reorder\n" "    .set at\n" );
__asm__( ".section .text\n" "    .set noat\n" "    .set noreorder\n" "    .include \"" "asm/nonmatchings/code_20470" "/" "func_800B58C0" ".s\"\n" "    .set reorder\n" "    .set at\n" );
__asm__( ".section .text\n" "    .set noat\n" "    .set noreorder\n" "    .include \"" "asm/nonmatchings/code_20470" "/" "func_800B5910" ".s\"\n" "    .set reorder\n" "    .set at\n" );
