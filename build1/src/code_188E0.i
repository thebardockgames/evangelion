...
__asm__( ".section .text\n" "    .set noat\n" "    .set noreorder\n" "    .include \"" "asm/nonmatchings/code_188E0" "/" "func_800ADCE0" ".s\"\n" "    .set reorder\n" "    .set at\n" );
__asm__( ".section .text\n" "    .set noat\n" "    .set noreorder\n" "    .include \"" "asm/nonmatchings/code_188E0" "/" "func_800ADCFC" ".s\"\n" "    .set reorder\n" "    .set at\n" );
__asm__( ".section .text\n" "    .set noat\n" "    .set noreorder\n" "    .include \"" "asm/nonmatchings/code_188E0" "/" "func_800ADD20" ".s\"\n" "    .set reorder\n" "    .set at\n" );
