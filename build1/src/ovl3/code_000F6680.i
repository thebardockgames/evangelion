...
typedef u16 String[];
String D_800691D0_ovl3 = {267,162,250,301,85,252,227,64,54,58,1,154,267,19,252,297,69,238,130,66,0};
String D_800691FC_ovl3 = {272,300,292,226,201,244,235,174,48,290,329,18,0};
String D_80069218_ovl3 = {101,95,92,121,335,308,47,80,30,214,153,178,0};
String D_80069234_ovl3 = {228,58,65,82,193,264,69,213,322,47,336,18,0};
String D_80069250_ovl3 = {25,450,451,17,16,246,131,452,236,453,419,420,26,0};
void func_8004D170_ovl3(void) {
    FontParams sp18;
    u32 temp_v0;
    func_80038424_ovl3();
    func_800A3624(((UnkStruct80036494*)func_80036780_ovl3(0x802F9800, 0x1B3, 9, 0x19))->unkC, 0x40, 0xC0);
...
__asm__( ".section .text\n" "    .set noat\n" "    .set noreorder\n" "    .include \"" "asm/nonmatchings/ovl3/code_000F6680" "/" "func_8004D254_ovl3" ".s\"\n" "    .set reorder\n" "    .set at\n" );
__asm__( ".section .text\n" "    .set noat\n" "    .set noreorder\n" "    .include \"" "asm/nonmatchings/ovl3/code_000F6680" "/" "func_8004D560_ovl3" ".s\"\n" "    .set reorder\n" "    .set at\n" );
__asm__( ".section .text\n" "    .set noat\n" "    .set noreorder\n" "    .include \"" "asm/nonmatchings/ovl3/code_000F6680" "/" "func_8004DA18_ovl3" ".s\"\n" "    .set reorder\n" "    .set at\n" );
__asm__( ".section .text\n" "    .set noat\n" "    .set noreorder\n" "    .include \"" "asm/nonmatchings/ovl3/code_000F6680" "/" "func_8004DD30_ovl3" ".s\"\n" "    .set reorder\n" "    .set at\n" );
__asm__( ".section .text\n" "    .set noat\n" "    .set noreorder\n" "    .include \"" "asm/nonmatchings/ovl3/code_000F6680" "/" "func_8004DF20_ovl3" ".s\"\n" "    .set reorder\n" "    .set at\n" );
__asm__( ".section .text\n" "    .set noat\n" "    .set noreorder\n" "    .include \"" "asm/nonmatchings/ovl3/code_000F6680" "/" "func_8004E1C4_ovl3" ".s\"\n" "    .set reorder\n" "    .set at\n" );
__asm__( ".section .text\n" "    .set noat\n" "    .set noreorder\n" "    .include \"" "asm/nonmatchings/ovl3/code_000F6680" "/" "func_8004E1F8_ovl3" ".s\"\n" "    .set reorder\n" "    .set at\n" );
